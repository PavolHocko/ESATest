...
{
    internal class SortedListFullLockSample : IKeyValueCollection
    {
        private SortedList<int, char> _collection = new SortedList<int, char>();

        public string Name => nameof(SortedListFullLockSample);
